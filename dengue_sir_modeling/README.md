...
2. **Exploratory Data Analysis (`report_visualizer.py`):** Plotted daily infections, mortality trends, and cumulative case distributions using Matplotlib.
3. **Epidemiological Modeling (`main.py`):**
